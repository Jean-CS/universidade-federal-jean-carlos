        ...
        <div class="full-width-split__inner">
          ...
          <?php 
            ...
            while($homepageEvents->have_posts()) {
              ...
              // 1st arg: file you want to include
              // 2nd arg: name to append to file
              // example: get_template_part('template-parts/event', 'something');
              //          will search for file named 'template-parts/event-something';
        ...
        <div class="full-width-split__inner">
          ...
          <?php 
            $homepagePosts = new WP_Query(array(
              'posts_per_page' => 2,
              //'category_name' => 'awards', (only posts of category awards)
